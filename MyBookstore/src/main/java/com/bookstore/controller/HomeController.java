...
public class HomeController {
	...
	private String bookShelf(Model model, Principal principal) {
	...
	@RequestMapping("/") // By default for get request
	public String index() {
		return "index";
	}
	...
	public String forgetPassword(HttpServletRequest request, @ModelAttribute("email") String userEmail, Model model) {
		...
		String token = UUID.randomUUID().toString(); // Universal unique id
	...
	public String newUser(Locale locale, @RequestParam("token") String token, Model model) {
		...
		/* Check is current login session belongs to the "user" */
	...
	public String listOfCeditCards(Model model, Principal principal, HttpServletRequest request) {
		User user = userService.findByUsername(principal.getName());
		model.addAttribute("user", user);
		model.addAttribute("userPaymentList", user.getUserPaymentList());
		model.addAttribute("userShippingList", user.getUserShippingList());
...
//		model.addAttribute("listOfShippingAddresses", true);
	...
	public String setDefaultShipping(
			@ModelAttribute("defaultUserShippingAddressId") Long defaultShippingId, Principal principal, Model model) {
	...
	public String removeUserShippingAddress(
			@ModelAttribute("id") Long shippingId, Principal principal, Model model
			) {
		User user = userService.findByUsername(principal.getName());
		UserShipping userShipping = userShippingService.findById(shippingId);
